...
const NAV = [
  ...
  { label: 'Validación asistentes', path: '/admin/validation', icon: '✅', roles: ['ADMIN', 'PHYSICAL_TRAINER'] },
  { label: 'Validación profesores', path: '/admin/conflicts', icon: '⚖️', roles: ['ADMIN', 'PHYSICAL_TRAINER'] },
