...
// en NULL. Usar `NOT (from <= hoy AND until >= hoy)` los EXCLUÍA, porque en
// SQL `NULL <= hoy` es NULL y `NOT NULL` es NULL (la fila no pasa el WHERE).
// La negación explícita por De Morgan cubre los NULL de forma segura: no está
// suspendido si falta cualquiera de las fechas, o la suspensión ya terminó, o
// aún no empieza.
